#ifndef SPHDYNAMIC_SYSTEM_RENDERABLE_HPP
#define SPHDYNAMIC_SYSTEM_RENDERABLE_HPP

#include <vector>

#include "SPHDynamicSystem.hpp"
 ...
 */
class SPHDynamicSystemRenderable : public HierarchicalRenderable
{
public:
    ~SPHDynamicSystemRenderable();
     ...
     */
    SPHDynamicSystemRenderable(SPHDynamicSystemPtr system);
     ...
     */
    void setDynamicSystem(const SPHDynamicSystemPtr &system);
...
typedef std::shared_ptr<SPHDynamicSystemRenderable> SPHDynamicSystemRenderablePtr;
